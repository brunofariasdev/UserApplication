            ...
            <div class="w-full lg:w-5/6">
                <div>
                    <div class="flex justify-end w-full items-end mb-1">
                        <button
                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-white-700 rounded"
                    ...
                    <table class="min-w-max w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-left" id="table">Email</th>
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100"
                                ...
                                <td class="py-3 px-6 text-center hidden md:block">
                                    <div class="flex items-center">
